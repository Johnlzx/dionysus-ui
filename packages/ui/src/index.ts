/**
 * [INPUT]: 依赖 ui/src 内部原语、Prismatic Button、左右侧栏、紧凑选择/下拉浮层、原位编辑、主题与类名工具模块
 * [OUTPUT]: 对外提供 @dionysus/ui 的稳定公共导出面、Compact Select、Prismatic Button、Inline Edit 模式与 App Shell/浮动面板运动契约
